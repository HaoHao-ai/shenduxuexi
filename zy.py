...
parent_dir = 'C:\\Users\\Lenovo\\Desktop\\shendu\\train'
save_dir = 'C:\\Users\\Lenovo\\Desktop\\shendu'
...
X_test = extract_features_test('C:\\Users\\Lenovo\\Desktop\\shendu\\test_a')
X_test = np.vstack(X_test)
predictions = model.predict(X_test.reshape(-1, 16, 8, 1))
preds = np.argmax(predictions, axis=1)
preds = [label_dict_inv[x] for x in preds]

path = glob.glob('C:\\Users\\Lenovo\\Desktop\\shendu\\test_a/*.wav')
